...
class ManagePizza {
    ...
    generatePizza(pizzaName, pizzaCalorie, pizzaPrice, feltetekList, meret) {
    ...
    getAllPizzaFromLocalStorage() {
        ...
        for (let i = 1; i < localStorage.length; i++) {
            ...
            if (pizzaString != null) {
                ...
                let pizzaClass = new Pizza(pizzaObj.nev, pizzaObj._kaloriaSzam, pizzaObj._ar, pizzaObj.feltetekList, pizzaObj._meret);
